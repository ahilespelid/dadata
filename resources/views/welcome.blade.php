...
<form class="obratnuj-zvonok" id='back' autocomplete="off" action='/api/form' method='post'>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener("submit", e => {
        ...
        xhr.addEventListener("load", e => {
            ...
            res.style.background = ('ok' == data.result) ? 'rgb(50,250,50)' : 'rgb(250,50,50)';
            res.style.display = 'block';
            res.innerText = data.mes;
